  ...
  */
    ...
    class Button {
        public:            
             ...
             */
            Button(unsigned short pin, unsigned long timeLongPress);
             ...
             */
            Button(unsigned short pin, unsigned long timeLongPress, ptrProcedure ptrActionShort, ptrProcedure ptrActionLong);
        ...
        private:
            unsigned short pin;                             // Pin of the button to read the status.
